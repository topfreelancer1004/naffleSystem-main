    ...
    <>
      <Row className="CoverSystem" justify="center">
        <Row className="SystemInRow" justify="center">
          <Row className="SystemDes" justify="center" align="middle">
            <Col className="SystemInfo">
              <span className="SystemType">Naffle</span>
          ...
          <Link to={`/${PUBLIC_PREFIX_PATH}/newcollection`}><Button type="primary" className="ViewAllCollection">View all collections</Button></Link>
        </Row>
      </Row>
    </>
  );
